...
* option : <br>
     ...
     **-resume** : Use this option to resume the pipeline at [PART2](https://github.com/itmat/Normalization/tree/master#part2). You may edit the &lt;file of sample dirs> file and/or change the highexpressor cutoff value.<br>
