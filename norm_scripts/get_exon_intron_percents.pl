...
my $quantsfile_u_sense = "$sampledir/EIJ/Unique/sense/$id.filtered_u.sense.exonquants";
my $quantsfile_u_antisense = "$sampledir/EIJ/Unique/antisense/$id.filtered_u.antisense.exonquants";
my $quantsfile_nu_sense = "$sampledir/EIJ/NU/sense/$id.filtered_nu.sense.exonquants";
my $quantsfile_nu_antisense = "$sampledir/EIJ/NU/antisense/$id.filtered_nu.antisense.exonquants";
...
my $quantsfile_u_sense_i = "$sampledir/EIJ/Unique/sense/$id.filtered_u.sense.intronquants";
my $quantsfile_u_antisense_i = "$sampledir/EIJ/Unique/antisense/$id.filtered_u.antisense.intronquants";
my $quantsfile_nu_sense_i = "$sampledir/EIJ/NU/sense/$id.filtered_nu.sense.intronquants";
my $quantsfile_nu_antisense_i = "$sampledir/EIJ/NU/antisense/$id.filtered_nu.antisense.intronquants";
